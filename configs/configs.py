...
config_schema_dict = {
    ...
    "hyper":    ["max_depth","n_estimators","subsample","learning_rate","min_samples_leaf","fl_coefficient","power","uniform_label","n_bins","uloss","batchSize","num_of_layers","num_of_nodes","dropout","epochs","lambdaTag","lambdaReg","lambdaGR"],
}
